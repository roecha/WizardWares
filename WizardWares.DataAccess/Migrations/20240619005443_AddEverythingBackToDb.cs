...
{
    /// <inheritdoc />
    public partial class AddEverythingBackToDb : Migration
    {
        /// <inheritdoc />
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.InsertData(
                table: "Products",
                columns: new[] { "Id", "CategoryId", "Description", "ImageUrl", "Name", "Price", "RarityId", "TradeItem" },
                values: new object[,]
                {
                    { 1, 1, "Drink this potion to recover 50 health.", "", "inferior health potion", 15.0, 1, "A piece of hidden lore" },
                    { 2, 1, "Drink this potion to recover 50 stamina.", "", "inferior stamina potion", 15.0, 1, "A piece of hidden lore" },
                    { 3, 1, "Drink this potion to recover 50 mana.", "", "inferior mana potion", 15.0, 1, "A piece of hidden lore" }
                });
